        ...
        {!isGameOver ? (
          <Card className="p-12 border-0 shadow-2xl bg-gradient-to-br from-blue-50 to-cyan-50">
            <div className="text-center">
              <h2 className="text-2xl mb-8 text-gray-700">Multiply Madness</h2>
              ...
              {feedback === 'correct' && (
                <div className="text-2xl text-green-600 mb-6">✓ Correct! +{15 + Math.floor(timeLeft / 10)} points</div>
              )}
              {feedback === 'incorrect' && (
                <div className="text-2xl text-red-600 mb-6">✗ Try again!</div>
              )}
